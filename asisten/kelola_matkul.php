...
<div class="bg-white p-6 rounded-lg shadow-md mb-8">
    ...
    <form action="kelola_matkul.php" method="POST">
        ...
        <?php if ($id_edit): ?>
            <a href="kelola_matkul.php" class="ml-3 inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">Batal</a>
        <?php endif; ?>
    </form>
</div>
                ...
                <?php if ($result && $result->num_rows > 0): ?>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                            <a href="kelola_modul.php?id_praktikum=<?php echo $row['id']; ?>" class="text-green-600 hover:text-green-900 mr-3">Kelola Modul</a>
                            <a href="kelola_matkul.php?edit_id=<?php echo $row['id']; ?>" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
                            <a href="kelola_matkul.php?hapus_id=<?php echo $row['id']; ?>" class="text-red-600 hover:text-red-900" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">Hapus</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                <?php else: ?>
