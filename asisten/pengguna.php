...
<div class="bg-white p-6 rounded-lg shadow-md mb-8">
    ...
    <form action="pengguna.php" method="POST" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div>
                ...
                <?php if ($result_users && $result_users->num_rows > 0): ?>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                            <a href="pengguna.php?hapus_id=<?php echo $user['id']; ?>" class="text-red-600 hover:text-red-900" onclick="return confirm('Yakin ingin menghapus pengguna ini?');">Hapus</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                <?php endif; ?>
