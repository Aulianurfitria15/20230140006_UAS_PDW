...
<div class="bg-white p-6 rounded-lg shadow-md mb-8">
    ...
    <form action="laporan.php" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div>
            ...
            <select id="filter_praktikum" name="filter_praktikum" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm">
        ...
        <div>
            ...
            <select id="filter_mahasiswa" name="filter_mahasiswa" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm">
        ...
        <div>
            ...
            <select id="filter_status" name="filter_status" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm">
        ...
        <div class="self-end">
            ...
            <a href="laporan.php" class="ml-2 inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">Reset</a>
        </div>
    </form>
</div>
                ...
                <?php if ($result_laporan && $result_laporan->num_rows > 0): ?>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                            <a href="asisten_beri_nilai.php?id_laporan=<?php echo $row['id_laporan']; ?>" class="text-indigo-600 hover:text-indigo-900">
